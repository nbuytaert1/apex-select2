...
''||unistr('\000a')||
'  l_select_list_type        gt_string := p_item.attribute_01;'||unistr('\000a')||
'  l_min_results_for_search  gt_string '||
':= p_item.attribute_02;'||unistr('\000a')||
...
'  l_'||
'null_optgroup_label_cmp gt_string := p_item.attribute_09;'||unistr('\000a')||
...
'  l_lazy_append_row_count   gt_s'||
'tring := p_item.attribute_15;'||unistr('\000a')||
''||unistr('\000a')||
...
'  l_cascade_items_to_submit_jq gt_string := apex_plugin_util.pag'||
'e_item_names_to_jquery(p_item.ajax_items_to_submit);'||unistr('\000a')||
...
'      l_code := l_code || '''||unistr('\000a')||
'        formatSelectionToo'||
'Big: function(maxSize) {'||unistr('\000a')||
...
'                          msg = msg.replace("#PAGENUMBER#", pageNum'||
'ber);'||unistr('\000a')||
'                          return msg;'||unistr('\000a')||
'                        },'';'||unistr('\000a')||
'    end if;'||unistr('\000a')||
...
'        else l_search_logic := ''return text.toUpperCase().inde'||
'xOf(term.toUpperCase()) >= 0;'';'||unistr('\000a')||
...
'sys.htf.escape_sc(l_selected_values(i)), false, true) ||'||unistr('\000a')||
...
'    end if;'||unistr('\000a')||
''||unistr('\000a')||
'    if (l_select_list_type = ''TAG'' and l_lazy_loading is not null) then'||unistr('\000a')||
'      l_code := l_code || '''||unistr('\000a')||
...
''||unistr('\000a')||
'    if (l_select_list_type = ''TAG'' and p_'||
'include_tags) then'||unistr('\000a')||
...
'  begin'||unistr('\000a')||
'    l_code := '''||unistr('\000a')||
'      $("'' || l_item_jq || ''").select2("container").find("ul.se'||
'lect2-choices").sortable({'||unistr('\000a')||
...
'    apex_plugin_util.debug_page_item(p_plugin, p_item, p_value, p_is_readonly'||
...
'      apex_pl'||
'ugin_util.print_display_only('||unistr('\000a')||
...
'  apex_javascript.add_library('||unistr('\000a')||
'    p'||
'_name      => ''select2-apex'','||unistr('\000a')||
'    p_directory => p_plugin.file_prefix,'||unistr('\000a')||
'    p_version   => null'||unistr('\000a')||
'  );'||unistr('\000a')||
...
'        p_version   => null'||unistr('\000a')||
'      );'||unistr('\000a')||
'    elsif (l_apex_version = ''4.2'') then'||unistr('\000a')||
'      apex_javascript.add_library('||unistr('\000a')||
'        p_name      => ''jquery.ui.sortable.min'','||unistr('\000a')||
'        p_directory => ''#IMAGE_PREFIX#l'||
'ibraries/jquery-ui/1.8.22/ui/minified/'','||unistr('\000a')||
'        p_version   => null'||unistr('\000a')||
'      );'||unistr('\000a')||
'    else'||unistr('\000a')||
'      apex_javascript.add_library('||unistr('\000a')||
...
''||unistr('\000a')||
'  if (p_item.lov_casca'||
'de_parent_items is not null) then'||unistr('\000a')||
...
''||unistr('\000a')||
'    if (p_'||
'item.ajax_optimize_refresh) then'||unistr('\000a')||
...
'    end if;'||unistr('\000a')||
'      l_onload'||
'_code := l_onload_code || '''||unistr('\000a')||
...
'    if (l_select_list_type = ''TAG'' and l_return_value_base'||
'd_on = ''RETURN'') then'||unistr('\000a')||
'      l_onload_code := l_onload_code || '''||unistr('\000a')||
'              dataType: "json",'';'||unistr('\000a')||
'    else'||unistr('\000a')||
'      l_onload_code := l_onload_code || '''||unistr('\000a')||
...
'    if (l_select_list_type = ''TAG'') then'||unistr('\000a')||
'      if (l_retur'||
'n_value_based_on = ''DISPLAY'') then'||unistr('\000a')||
'        l_onload_code := l_onload_code || '''||unistr('\000a')||
...
'    l_onload_code := l_onload_code || '''||unistr('\000a')||
'      apex.jQuery("'' || l'||
'_item_jq || ''").each(function() {'||unistr('\000a')||
'        apex.widget.initPageItem(this.id, {'||unistr('\000a')||
'          setValue: function(pValue, pDisplayValue) {'||unistr('\000a')||
'            apex.jQuery("#" + this.id).val(pValue.split("'' || nvl(l_source_value_separator, '':'') || ''")).trigger("change");'||unistr('\000a')||
'          }'||unistr('\000a')||
'        });'||unistr('\000a')||
'      });'';'||unistr('\000a')||
'  end if;'||unistr('\000a')||
...
''||unistr('\000a')||
'  l_lov               '||
'       apex_plugin_util.t_column_value_list;'||unistr('\000a')||
'  l_json                     gt_string;'||unistr('\000a')||
...
''||unistr('\000a')||
'  l_result                   apex_plugin.t_pag'||
'e_item_ajax_result;'||unistr('\000a')||
'begin'||unistr('\000a')||
...
'    -- the percentage wildcard returns all rows whenever the search s'||
'tring is null'||unistr('\000a')||
'    case l_search_logic'||unistr('\000a')||
...
'        l'||
'_apex_plugin_search_logic := apex_plugin_util.c_search_lookup; -- uses = value'||unistr('\000a')||
...
'      else'||unistr('\000a')||
'        l_apex'||
'_plugin_search_logic := apex_plugin_util.c_search_like_ignore; -- uses LIKE %VALUE% with UPPER'||unistr('\000a')||
'    end case;'||unistr('\000a')||
''||unistr('\000a')||
...
'               p_component_name   => p_item.name,'||unistr('\000a')||
'               p_search_type  '||
'    => l_apex_plugin_search_logic,'||unistr('\000a')||
...
wwv_flow_api.create_plugin_attribute (
  p_id => 12020513414296881 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_plugin_id => 11532843359293595 + wwv_flow_api.g_id_offset
 ,p_attribute_scope => 'APPLICATION'
...
wwv_flow_api.create_plugin_attr_value (
  p_id => 12025729690301596 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_plugin_attribute_id => 12020513414296881 + wwv_flow_api.g_id_offset
 ,p_display_sequence => 10
 ,p_display_value => 'Select2'
 ,p_return_value => 'SELECT2'
  );
wwv_flow_api.create_plugin_attr_value (
  p_id => 12030000731302661 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_plugin_attribute_id => 12020513414296881 + wwv_flow_api.g_id_offset
 ,p_display_sequence => 20
...
wwv_flow_api.g_varchar2_table(14) := '6C6374626C757222293B0D0A202020202020242874686973292E747269676765722822626C757222293B0D0A202020207D293B0D0A20207D0D0A7D3B';
null;
...
wwv_flow_api.create_plugin_file (
  p_id => 11905121430929747 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_plugin_id => 11532843359293595 + wwv_flow_api.g_id_offset
...
wwv_flow_api.create_plugin_file (
  p_id => 12050121246470886 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_plugin_id => 11532843359293595 + wwv_flow_api.g_id_offset
